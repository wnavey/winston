...
**Architecture diagrams:** [`architecture.html`](architecture.html) — boxes-and-arrows for today's pipelines and for each phase (P0a–P3), the runbook sequence, the ER changes, and the decisions/questions index. Open it in a browser; this markdown wins if they differ.
