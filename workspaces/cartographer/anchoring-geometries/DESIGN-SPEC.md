...
| P2 | substation#310 (`cartographer_anchors`, four RPCs) · cartographer (anchor-geometry scripts, stacked on #31) · bureau (`anchor-geometry` runbook) |
