...
def main():
    ...
    lines.append("")
    lines.append("All three Goal B variants moved up. Modest absolute movement (3 more measurement-majority items, on a 51-item denominator), but consistent across both raw and denominator-adjusted views.")
    lines.append("")
    lines.append("## Verdict distribution on the 51 expected-md items")
    lines.append("")
