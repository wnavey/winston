#!/usr/bin/env python3
"""Generate run-9-no-vision-check-analysis.md.
...
TSV = HERE.parent / "el-md-exp-var2-run9-vision-check-calls-compared-to-expected.tsv"
RUNS = WORKSPACE / "source-runs" / "el-md-exp" / "var-2" / "output" / "runs"
OUT = HERE.parent / "run-9-no-vision-check-analysis.md"
