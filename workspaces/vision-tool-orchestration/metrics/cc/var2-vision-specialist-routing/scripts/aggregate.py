...
For var2 the agent only has ``vision_check`` exposed; ``tool_called``
values reflect what vision_check internally dispatched to:
  none / vision-check-generic / vision-check-inspect-drawing /
  vision-check-measure-distance.
"""
